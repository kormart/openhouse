export default {
    ...
    presentations: [
        ...
        {title: "Cyber Security", byline: "Are you ready for the next attack?", presenter: "Shahid Raza", text: "Cybercriminals, we don’t like them, but we must give them credit for their spirit of innovation. The ever-increasing range and sophistication level of cyber-attacks makes cybersecurity a continuous process, like a cat and mouse game, where the balance of power changes over time. This talk will highlight both short-term and strategic long-term research initiatives, with the potential to increase Swedish competitiveness in defending against cyber-attackers with heterogenous capabilities.", link: "common_teams_link"},
        ...
        {title: "AI & Ecosystems", byline: "How AI can help SMEs in the ecosystem", presenter: "Jeanette Nilsson", text: "The Swedish and EU ecosystems for AI offer a wide range of initiatives and tools to support industry, SMEs, and the public sector in their digital transformation. SMEs seeking to explore the potential of data-driven innovation and AI can have difficulties navigating these offerings and getting help with their change journey. We discuss how RISE works with the AI ecosystems and supports partners.", link: "common_teams_link"},
